...
public class IntegrationRepository : IIntegrationRepository
{
    ...
    {
        _logger.LogDebug("IntegrationRepository: Looking for credential with ID {CredentialId}", credentialId);
        ...
        if (credential != null)
        {
            _logger.LogDebug("IntegrationRepository: Found credential with ID {CredentialId}", credential.Id);
        }
        else
        {
            _logger.LogDebug("IntegrationRepository: No credential found with ID {CredentialId}", credentialId);
        }
